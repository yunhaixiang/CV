...
Programming &  \skill{skillAdvanced}{Python}, \skill{skillFamiliar}{Lean}, \skill{skillFamiliar}{C/C++}, \skill{skillBeginner}{C\#}, \skill{skillBeginner}{Rust},  \skill{skillBeginner}{JavaScript/TypeScript}, \skill{skillBeginner}{Haskell}\\
Computing & \skill{skillExpert}{SageMath}, \skill{skillProficient}{SQL}, \skill{skillProficient}{NumPy}, \skill{skillProficient}{SciPy}, \skill{skillFamiliar}{Pandas}, \skill{skillFamiliar}{PyTorch}, \skill{skillFamiliar}{XGBoost}, \skill{skillFamiliar}{Sklearn},  \skill{skillFamiliar}{Slurm}\\
Graphics & \skill{skillProficient}{Cinema 4D}, \skill{skillBeginner}{Blender}, \skill{skillBeginner}{Unity}, \skill{skillBeginner}{Godot}\\
DevOps & \skill{skillBeginner}{Docker}, \skill{skillBeginner}{Jenkins}, \skill{skillBeginner}{FastAPI}\\
Hobbies & \skill{skillProficient}{Magic Tricks}, \skill{skillProficient}{Swimming}, \skill{skillBeginner}{Indie Games}, \skill{skillBeginner}{Jazz Music}\\
\end{tabular}
\vspace{0.3em}
\end{rSection}
\vspace{0.55em}
