...
\href{https://www.linkedin.com/in/yunhai-xiang/}{\faLinkedin\ yunhai-xiang}\quad
\href{https://www.youtube.com/@6functors}{\faYoutube\ 6functors}}
...
Programming &  \skill{skillAdvanced}{Python,} \skill{skillProficient}{SQL,} \skill{skillFamiliar}{Lean,} \skill{skillFamiliar}{C/C++,} \skill{skillBeginner}{C\#,} \skill{skillBeginner}{Rust,}  \skill{skillBeginner}{JavaScript/TypeScript,} \skill{skillBeginner}{Haskell}\\
DS/ML & \skill{skillProficient}{NumPy,} \skill{skillProficient}{SciPy,} \skill{skillFamiliar}{Pandas,} \skill{skillFamiliar}{PyTorch,} \skill{skillFamiliar}{XGBoost,} \skill{skillFamiliar}{Sklearn}\\
DevOps & \skill{skillBeginner}{Docker,} \skill{skillBeginner}{Jenkins,} \skill{skillBeginner}{FastAPI,} \skill{skillBeginner}{Slurm}\\
Graphics & \skill{skillProficient}{Cinema 4D,} \skill{skillBeginner}{Blender,} \skill{skillBeginner}{Unity,} \skill{skillBeginner}{Godot}\\
Hobbies & \skill{skillProficient}{Magic Tricks,} \skill{skillProficient}{Swimming,} \skill{skillBeginner}{Games Development} \\
\end{tabular}
\vspace{0.3em}
\end{rSection}
\vspace{0.55em}
...
\begin{list}{}{\leftmargin=0pt \labelwidth=0pt \labelsep=0pt \itemsep=-2pt}
...
\begin{rSubsection}{Meeting Organizations}{}{Organized or co-organized academic meetings}{}
...
\begin{rSection}{Selected Software Projects \& Open Source Contributions} \itemsep -3pt
    \begin{rSubsection}{Games and Graphics Softwares}{}{}{}
        \item Coming Soon.
    \end{rSubsection}
    \begin{rSubsection}{Mathematics and Scientific Computing}{}{}{}
        \item Coming Soon.
    \end{rSubsection}
    \begin{rSubsection}{Data Science and Quantitative Finance}{}{}{}
        \item Coming Soon.
    \end{rSubsection}
\end{rSection}

\begin{rSection}{Certifications} \itemsep -3pt
    \begin{rSubsection}{Language Proficiency}{}{}{}
        \item Coming Soon.
    \end{rSubsection}
    \begin{rSubsection}{Boot Camps \& Programs}{}{}{}
        \item Coming Soon.
    \end{rSubsection}
    \begin{rSubsection}{Technical Certifications}{}{}{}
        \item Coming Soon.
    \end{rSubsection}
\end{rSection}
