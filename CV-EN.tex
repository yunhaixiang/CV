...
Programming &  \skill{skillAdvanced}{Python}, \skill{skillProficient}{SQL}, \skill{skillProficient}{Lean}, \skill{skillFamiliar}{C/C++}\\
Libraries & \skill{skillFamiliar}{PyTorch} \\
Softwares & \skill{skillAdvanced}{Git}, \skill{skillAdvanced}{LaTeX}, \skill{skillAdvanced}{SageMath}, \skill{skillProficient}{Cinema 4D}\\
