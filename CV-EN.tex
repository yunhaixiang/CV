...
Programming &  \skill{skillAdvanced}{Python}, \skill{skillFamiliar}{Lean}, \skill{skillFamiliar}{C/C++}, \skill{skillBeginner}{C\#}, \skill{skillBeginner}{Rust}, \skill{skillBeginner}{Haskell}, \skill{skillBeginner}{Scheme}, \skill{skillBeginner}{JavaScript/TypeScript}\\
...
Hobbies & \skill{skillProficient}{Magic Tricks}, \skill{skillBeginner}{Indie Games}\\
\end{tabular}
\vspace{0.3em}
\end{rSection}
\vspace{0.55em}
