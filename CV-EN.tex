...
DSLs & \skill{skillExpert}{LaTeX}, \skill{skillProficient}{SQL}, \skill{skillFamiliar}{HTML}, \skill{skillFamiliar}{CSS}\iffalse, \skill{skillBeginner}{GDScript}\fi\\
Softwares & \skill{skillProficient}{Cinema 4D}\iffalse, \skill{skillBeginner}{Blender}, \skill{skillBeginner}{Unity}, \skill{skillBeginner}{Godot}\fi\\
