...
\newlength{\personalDetailsLabelWidth}
\name{Yunhai Xiang} 
\address{\today}
...
\settowidth{\personalDetailsLabelWidth}{\bfseries Pronouns}
\begin{tabular}{ @{} >{\bfseries}p{\personalDetailsLabelWidth} @{\hspace{6ex}} >{\raggedright\arraybackslash}p{\dimexpr\linewidth-\personalDetailsLabelWidth-6ex\relax} @{} }
Name & Yunhai Xiang (in Chinese: \begin{CJK*}{UTF8}{gbsn}项云海\end{CJK*}, pronounced ``yee-o-en-hi si-ang'') \\
Pronouns & He/Him/His/Himself \\
Email & \href{mailto:yxiang72@uwo.ca}{yxiang72@uwo.ca} (for encrypted emails: \href{https://github.com/yunhaixiang/open-pgp}{PGP Public Key}) 
\\Website & \href{https://yunhaimath.com/}{yunhaimath.com}\\ 
GitHub & \href{https://github.com/yunhaixiang}{yunhaixiang}\\
Bio & I am a mathematician with experience in number theory and arithmetic geometry.
\end{tabular}
\vspace{0.3em}
\end{rSection}
...
\rSubsectionEducation{Western University}{2025 --- Now}{Ph.D. in Mathematics (in progress)}{London, ON, Canada}{Advisor: Chris Hall\\Specialization: Number Theory and Arithmetic Geometry}
\smallskip
\rSubsectionEducation{Western University}{2024}{M.Sc. in Mathematics}{London, ON, Canada}{Advisor: Chris Hall}
\smallskip
...
Languages & \skill{skillExpert}{Mandarin}, \skill{skillExpert}{English}, \skill{skillBeginner}{French}\\
Programming &  \skill{skillAdvanced}{Python}, \skill{skillFamiliar}{Lean}, \skill{skillFamiliar}{C/C++}, \skill{skillBeginner}{C\#}, \skill{skillBeginner}{Rust}, \skill{skillBeginner}{Haskell}, \skill{skillBeginner}{JavaScript/TypeScript}\\
...
DSLs & \skill{skillExpert}{LaTeX}, \skill{skillProficient}{SQL}, \skill{skillFamiliar}{HTML}, \skill{skillFamiliar}{CSS}, \skill{skillBeginner}{GDScript}\\
...
Hobbies & \skill{skillProficient}{Magic Tricks}, \skill{skillBeginner}{Game Development}\\
\end{tabular}
\vspace{0.3em}
\end{rSection}
\vspace{0.55em}
...
\begin{rSubsection}{Conferences Attendance \& Presentations}{}{Attended academic conferences and given research or expository talks}{}
\item FrontierMath Open Problems Workshop,  Summer 2026, UToronto
\item Homotopy Theory, K-theory, and Topological Data Analysis Conference, Summer 2026, UWO
...
\item University of Western Ontario Research in Computer Science (UWORCS), Winter 2026, UWO
...
\end{rSubsection}
\begin{rSubsection}{Seminar Attendance \& Presentations}{}{Attended academic seminars and given research or expository talks}{}
    \item {\em Hyperelliptic Jacobians and Hasse–Witt Matrix}, Algebraic Geometry Student Seminar, UWO
    \item {\em Trace of Frobenius}, Winter 2026, Graduate Student Seminar, UWO
    \item {\em Brauer Groups of Fields Part II}, Winter 2026, Algebraic Geometry Student Seminar, UWO
    \item {\em Brauer Groups of Fields Part I}, Winter 2026, Algebraic Geometry Student Seminar, UWO
...
\begin{rSection}{Teaching \& Mentoring} \itemsep -3pt
    ...
    \begin{rSubsection}{Teaching Assistantship}{}{Proctored and graded exams, graded homeworks, tutored at Help Centre, and taught tutorial sessions}{}
        ...
        \item CALCULUS 1501, \textit{Calculus II for Mathematical and Physical Sciences}, Winter 2025, Winter 2026
